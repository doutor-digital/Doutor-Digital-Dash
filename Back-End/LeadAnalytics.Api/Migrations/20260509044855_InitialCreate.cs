    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_sdr_agenda_eventos_SdrLeadId",
                table: "sdr_agenda_eventos",
                column: "SdrLeadId");

            migrationBuilder.CreateIndex(
                name: "IX_sdr_agenda_eventos_TenantId_Data",
                table: "sdr_agenda_eventos",
                columns: new[] { "TenantId", "Data" });

            migrationBuilder.CreateIndex(
                name: "IX_sdr_agenda_eventos_TenantId_Status",
                table: "sdr_agenda_eventos",
                columns: new[] { "TenantId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_sdr_audit_logs_TenantId_Action",
                table: "sdr_audit_logs",
                columns: new[] { "TenantId", "Action" });

            migrationBuilder.CreateIndex(
                name: "IX_sdr_audit_logs_TenantId_CreatedAt",
                table: "sdr_audit_logs",
                columns: new[] { "TenantId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_sdr_audit_logs_TenantId_EntityType_EntityId",
                table: "sdr_audit_logs",
                columns: new[] { "TenantId", "EntityType", "EntityId" });

            migrationBuilder.CreateIndex(
                name: "IX_sdr_audit_logs_UserId",
                table: "sdr_audit_logs",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_sdr_consultas_SdrLeadId",
                table: "sdr_consultas",
                column: "SdrLeadId");

            migrationBuilder.CreateIndex(
                name: "IX_sdr_consultas_TenantId_DataConsulta",
                table: "sdr_consultas",
                columns: new[] { "TenantId", "DataConsulta" });

            migrationBuilder.CreateIndex(
                name: "IX_sdr_leads_ImportBatchId",
                table: "sdr_leads",
                column: "ImportBatchId");

            migrationBuilder.CreateIndex(
                name: "IX_sdr_leads_ReviewedByUserId",
                table: "sdr_leads",
                column: "ReviewedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_sdr_leads_TenantId_CreatedAt",
                table: "sdr_leads",
                columns: new[] { "TenantId", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_sdr_leads_TenantId_Source",
                table: "sdr_leads",
                columns: new[] { "TenantId", "Source" });

            migrationBuilder.CreateIndex(
                name: "IX_sdr_leads_TenantId_Status",
                table: "sdr_leads",
                columns: new[] { "TenantId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_sdr_leads_UnitId",
                table: "sdr_leads",
                column: "UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_sdr_metas_TenantId_Mes",
                table: "sdr_metas",
                columns: new[] { "TenantId", "Mes" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_sdr_recebimentos_SdrConsultaId",
                table: "sdr_recebimentos",
                column: "SdrConsultaId");

            migrationBuilder.CreateIndex(
                name: "IX_sdr_recebimentos_SdrTratamentoId",
                table: "sdr_recebimentos",
                column: "SdrTratamentoId");

            migrationBuilder.CreateIndex(
                name: "IX_sdr_recebimentos_TenantId_DataRecebimento",
                table: "sdr_recebimentos",
                columns: new[] { "TenantId", "DataRecebimento" });

            migrationBuilder.CreateIndex(
                name: "IX_sdr_tarefas_SdrLeadId",
                table: "sdr_tarefas",
                column: "SdrLeadId");

            migrationBuilder.CreateIndex(
                name: "IX_sdr_tarefas_TenantId_DataVencimento",
                table: "sdr_tarefas",
                columns: new[] { "TenantId", "DataVencimento" });

            migrationBuilder.CreateIndex(
                name: "IX_sdr_tarefas_TenantId_Status",
                table: "sdr_tarefas",
                columns: new[] { "TenantId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_sdr_tratamentos_SdrConsultaId",
                table: "sdr_tratamentos",
                column: "SdrConsultaId");

            migrationBuilder.CreateIndex(
                name: "IX_sdr_tratamentos_SdrLeadId",
                table: "sdr_tratamentos",
                column: "SdrLeadId");

            migrationBuilder.CreateIndex(
                name: "IX_sdr_tratamentos_TenantId_CreatedAt",
                table: "sdr_tratamentos",
                columns: new[] { "TenantId", "CreatedAt" });
        }
