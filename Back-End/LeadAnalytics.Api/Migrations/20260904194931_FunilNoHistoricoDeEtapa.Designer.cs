...
namespace LeadAnalytics.Api.Migrations
{
    ...
    [Migration("20260904194931_FunilNoHistoricoDeEtapa")]
    partial class FunilNoHistoricoDeEtapa
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LeadAnalytics.Api.Models.AdCreative", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LeadAnalytics.Api.Models.FranquiaLeadLink", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateOnly>("DiaLancamento")
                        .HasColumnType("date");
                    ...
                    b.Property<decimal?>("PrecoFranquia")
                    ...
                    b.Property<decimal?>("ValorKommo")
                        .HasColumnType("numeric");

                    b.HasKey("Id");

                    b.HasIndex("UnitId", "DiaLancamento");

                    b.HasIndex("UnitId", "IdTreatment")
                        .IsUnique();

                    b.ToTable("franquia_lead_link", (string)null);
                });
            ...
            modelBuilder.Entity("LeadAnalytics.Api.Models.KpiGoal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("kpi_goals", (string)null);
                });
            ...
            modelBuilder.Entity("LeadAnalytics.Api.Models.Lead", b =>
                {
                    ...
                    b.Property<DateTime?>("AppointmentScheduledAtFilledAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("QualificationFilledAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("LeadAnalytics.Api.Models.LeadStageHistory", b =>
                {
                    ...
                    b.Property<string>("CorrectedByEmail")
                        .HasMaxLength(256)
                    ...
                    b.Property<DateTime?>("CorrectedChangedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("LeadAnalytics.Api.Models.SavedFilter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LeadAnalytics.Api.Models.SpineScheduleSnapshot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime>("DateAttendanceUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateOnly>("DiaLocal")
                        .HasColumnType("date");
                    ...
                    b.Property<DateTime?>("ModifiedAtSpine")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("ModifiedBySpine")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.HasIndex("UnitId", "DiaLocal");

                    b.HasIndex("UnitId", "IdSchedule")
                        .IsUnique();

                    b.ToTable("spine_schedule_snapshot", (string)null);
                });
