...
DEPARA = {
    ...
    "10_NAO_PERTURBAR":            {"to": (PIPELINE_COMERCIAL, 143), "loss": "Não perturbar"},
    "11_NAo_deu_continuidade":     {"to": (PIPELINE_COMERCIAL, 143), "loss": "Não deu continuidade ao atendimento"},
    "12_LEAD_MORTO":               {"to": (PIPELINE_COMERCIAL, 143), "loss": "Lead morto"},
}
